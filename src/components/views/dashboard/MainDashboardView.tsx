  ...
  return (
    <main>
      <section className="container">
        <div className="relative z-[1] min-h-[225px] w-full bg-gradient-to-tr    from-purple-700 py-4 rounded-br-2xl rounded-bl-2xl via-violet-500 to-violet-400">
          <h3 className="px-3 mt-10 text-center text-base font-medium text-white">
            LosBlancos
          </h3>
          <AreaChartComponent />
        </div>
        <div className=" px-3 h-[calc(100vh-195px)] w-full border rounded-xl -mt-20 dark:bg-gray-900">
